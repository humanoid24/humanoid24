...
<head>
    ...
    <title>Kanojo Mo Kanojo Season 1</title>
    <style>
        /*button episode*/
.grid{
    display: grid;
...
<body>
    ...
    <div class="gkuen">
        <iframe id="videoframe" src="https://www.youtube.com/embed/_bQuLI4m_Lo?si=xSYryy3SGHN9cjwO_" frameborder="0"
        allowfullscreen="true">
        </iframe>
    </div>
    <div class="video-description">
        <p>Kanojo Mo Kanojo Season 1 Episode 1</p>
    </div>
    <div class="grid">
            <button onclick="changeVideo('_bQuLI4m_Lo?si=xSYryy3SGHN9cjwO_','Kanojo mo Kanojo Episode 1')">Episode 1</button>
            <button onclick="changeVideo('0eGSHwFRrO8?si=buirdhZcPwmESM5h','Kanojo mo Kanojo Episode 2')">Episode 2</button>
            <button onclick="changeVideo('lO3SjZwnWAc?si=dywbQyO9cafO19ML','Kanojo mo Kanojo Episode 3')">Episode 3</button>
            <button onclick="changeVideo('r0X8wy0iYmo?si=UUMYcsnupjo5SiW-','Kanojo mo Kanojo Episode 4')">Episode 4</button>
            <button onclick="changeVideo('7ZtdiAh9HLM?si=zmcgWF6OHp-R889J','Kanojo mo Kanojo Episode 5')">Episode 5</button>
            <button onclick="changeVideo('RwGMVIidSeE?si=4ZWv8b3iecxHwpbh','Kanojo mo Kanojo Episode 6')">Episode 6</button>
            <button onclick="changeVideo('wJnddFGa8j0?si=m4Lt-enHJhMkMMux','Kanojo mo Kanojo Episode 7')">Episode 7</button>
            <button onclick="changeVideo('cOLzoj1bq3A?si=nfkZANwEbxOBGgCO','Kanojo mo Kanojo Episode 8')">Episode 8</button>
            <button onclick="changeVideo('_dGA7GdHltc?si=qE9VFHXjCmWNLe0R','Kanojo mo Kanojo Episode 9')">Episode 9</button>
            <button onclick="changeVideo('yTv7pNt1ogs?si=R-3eHBM234dG3P5C','Kanojo mo Kanojo Episode 10')">Episode 10</button>
            <button onclick="changeVideo('Xjm6FhXcUIE?si=RL6-B0w0PZ47yHL_','Kanojo mo Kanojo Episode 11')">Episode 11</button>
            <button onclick="changeVideo('UJtJWGVkqDI?si=vkgG_eOmPFVN5iFe','Kanojo mo Kanojo Episode 12')">Episode 12</button>
            </div>
