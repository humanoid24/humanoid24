...
<head>
    ...
    <title>Shachou, Battle no jikan desu!</title>
    <style>
        /*button episode*/
.grid{
    display: grid;
...
<body>
    ...
    <div class="gkuen">
        <iframe id="videoframe" src="https://www.youtube.com/embed/qAOaHUrihNk?si=jZqSyYV-xFtqhB52" frameborder="0"
        allowfullscreen="true">
        </iframe>
    </div>
    <div class="video-description">
        <p>Shachou, Battle no jikan desu! Episode 1</p>
    </div>
    <div class="grid">
            <button onclick="changeVideo('qAOaHUrihNk?si=jZqSyYV-xFtqhB52','Shachou, Battle no jikan desu! Episode 1')">Episode 1</button>
            <button onclick="changeVideo('-_2A974n4J0?si=T1slf87PffvNGt7p','Shachou, Battle no jikan desu! Episode 2')">Episode 2</button>
            <button onclick="changeVideo('gaxcpcI4g7E?si=6FpFuYJOO3rO3jp0','Shachou, Battle no jikan desu! Episode 3')">Episode 3</button>
            <button onclick="changeVideo('IIC_62QLLxE?si=K19ydLWBF44tZI21','Shachou, Battle no jikan desu! Episode 4')">Episode 4</button>
            <button onclick="changeVideo('JyXvFr337Aw?si=PcqqWmcXSwrp-DWL','Shachou, Battle no jikan desu! Episode 5')">Episode 5</button>
            <button onclick="changeVideo('yRc3c6ghJsQ?si=Q08nPt-ZQV1tplvs','Shachou, Battle no jikan desu! Episode 6')">Episode 6</button>
            <button onclick="changeVideo('QniW8qkd_0k?si=qThfPZfySkY1L6ge','Shachou, Battle no jikan desu! Episode 7')">Episode 7</button>
            <button onclick="changeVideo('8cQmgTo-iS0?si=XopKDF0bF6tJ_vY1','Shachou, Battle no jikan desu! Episode 8')">Episode 8</button>
            <button onclick="changeVideo('juc0IRfu-tw?si=MpfTHD-FQP-OHWPY','Shachou, Battle no jikan desu! Episode 9')">Episode 9</button>
            <button onclick="changeVideo('mCLpQCQ3ArI?si=nh9pdWLdGM-U523m','Shachou, Battle no jikan desu! Episode 10')">Episode 10</button>
            <button onclick="changeVideo('WFZwsXP1jdU?si=NDXkhiISHsfULnF8','Shachou, Battle no jikan desu! Episode 11')">Episode 11</button>
            <button onclick="changeVideo('Tn8Obw9jP5s?si=9v3sZyhuOQCAwsFA','Shachou, Battle no jikan desu! Episode 12')">Episode 12</button>
            </div>
